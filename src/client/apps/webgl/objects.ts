...
export function createFloor(dim: number = 50, unit = 1): Object3D {
...
export function createAxis(dim: number = 10): Object3D {
    return {
        vertices: [
            -dim, 0.0,0.0,
            dim, 0.0,0.0, 0.0,
