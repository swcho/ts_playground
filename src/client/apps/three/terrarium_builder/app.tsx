...
function selectContainer() {
    ...
    function triTerr() {
        ...
        pyramid.rotateY(.75);
        let earth = new THREE.CubeGeometry(1.8, .2, 1.8);
...
function selectObjects() {
    ...
    function createPyramid() {
        ...
        // eye
        let geometrySphere = new THREE.SphereGeometry(.085, 32, 16);
        let materialSphere = new THREE.MeshLambertMaterial({ color: 0xffffff, shading: THREE.FlatShading });
        let sphere = new THREE.Mesh(geometrySphere, materialSphere);
        sphere.position.set(0, -.05, .10);
        magicPyramid.add(sphere);

        // pupil
        let geometryBox = new THREE.BoxGeometry(.085, .085, .05);
        let materialBox = new THREE.MeshNormalMaterial();
    ...
    let addUfo = document.getElementById('ufoBtn');
    addUfo.addEventListener('click', createUfo, false);

    function createUfo() {

        let geometry = new THREE.BoxGeometry(.35, .25, .25);
        let material = new THREE.MeshToonMaterial({ color: 0xffff00, transparent: true, opacity: 0 });
        let ufo = new THREE.Mesh(geometry, material);

        let geometrySphere = new THREE.SphereGeometry(.10, 4, 32);
        let materialSphere = new THREE.MeshToonMaterial({
            color: 0x3DCCC7,
            shininess: 500
        ...
        let geometryCylinder = new THREE.CylinderGeometry(.05, .25, .15, 32);
        let materialCylinder = new THREE.MeshToonMaterial({
    ...
    let addpalmTree = document.getElementById('palmBtn');
    addpalmTree.addEventListener('click', createpalmTree, false);

    function createpalmTree() {

        let geometry = new THREE.BoxGeometry(.35, 1.5, .25);
        geometry.translate(0, .5, 0);
        let material = new THREE.MeshBasicMaterial({ color: 0xffff00, transparent: true, opacity: 0 });
        let palmTree = new THREE.Mesh(geometry, material);

        let geometryCylinder = new THREE.CylinderGeometry(0.35, 0.45, .5, 6);
        let materialCylinder = new THREE.MeshNormalMaterial({ color: 0x948C75 } as any);
        let palmBase = new THREE.Mesh(geometryCylinder, materialCylinder);
        palmTree.add(palmBase);

        let geometry1 = new THREE.CylinderGeometry(0.20, 0.30, .5, 6);
        palmBase = new THREE.Mesh(geometry1, material);
        palmBase.position.set(-.025, .45, .0);
        palmBase.rotation.set(0, 0, .15);
        palmTree.add(palmBase);

        let geometry2 = new THREE.CylinderGeometry(0.05, 0.20, .5, 6);
        palmBase = new THREE.Mesh(geometry2, material);
        palmBase.position.set(-.15, .85, .0);
        palmBase.rotation.set(0, 0, .35);
        palmTree.add(palmBase);

        let geometry3 = new THREE.CylinderGeometry(0.015, 0.04, .25, 6);
        let palmTrunkTop = new THREE.Mesh(geometry3, material);
        ...
        let geometryExtrude = new THREE.ExtrudeGeometry(leafShape, extrudeSettings);

        let materialExtrude = new THREE.MeshToonMaterial({ color: 0x0CA4A5 });
        let Leaf = new THREE.Mesh(geometryExtrude, materialExtrude);
    ...
    let addTallFlower = document.getElementById('tallBtn');
    addTallFlower.addEventListener('click', createTallFlower, false);

    function createTallFlower() {

        let geometry = new THREE.BoxBufferGeometry(.10, .8, .10);
        geometry.translate(0, .35, .05);
        let material = new THREE.MeshBasicMaterial({ color: 0xffff00, transparent: true, opacity: 0 });
        let tallFlower = new THREE.Mesh(geometry, material);
        ...
        let geometryExtrude = new THREE.ExtrudeGeometry(leafShape, extrudeSettings);
        let materialExtrude = new THREE.MeshToonMaterial({ color: 0x1EEF94 });
        let Leaf = new THREE.Mesh(geometryExtrude, materialExtrude);
        ...
        let geometrySphere = new THREE.SphereGeometry(.15, .15, 12);
        let materialSphere = new THREE.MeshToonMaterial({
            shininess: 100
        });
        let sphere = new THREE.Mesh(geometrySphere, materialSphere);
    ...
    let addSmallFlower = document.getElementById('smallBtn');
    addSmallFlower.addEventListener('click', createSmallFlower, false);

    function createSmallFlower() {

        let geometry = new THREE.BoxGeometry(.25, .25, .08);
        geometry.translate(0, 0, .05);
        let material = new THREE.MeshBasicMaterial({ color: 0xffff00, transparent: true, opacity: 0 });
        let smallFlower = new THREE.Mesh(geometry, material);
        ...
        let geometrySphere = new THREE.SphereGeometry(.10, .10, 3);
        let materialSphere = new THREE.MeshToonMaterial({
            shininess: 100
        });
        let sphere = new THREE.Mesh(geometrySphere, materialSphere);
    ...
    let addAlien = document.getElementById('alienBtn');
    addAlien.addEventListener('click', createAlien, false);
    function createAlien() {

        let geometry = new THREE.BoxGeometry(.25, .55, .05);
        geometry.translate(0, -.25, 0);
        let material = new THREE.MeshBasicMaterial({ color: 0xffff00, transparent: true, opacity: 0 });
        let alienGuy = new THREE.Mesh(geometry, material);

        let geometrySphere = new THREE.SphereGeometry(.03, .03, 8);
        let materialSphere = new THREE.MeshToonMaterial();
        let leftEye = new THREE.Mesh(geometrySphere, materialSphere);
        ...
        let geometryExtrude = new THREE.ExtrudeGeometry(alienHead, extrudeSettings);
        let materialExtrude = new THREE.MeshToonMaterial({ color: 0x7FFF24 });
        let alienHeadExtrude = new THREE.Mesh(geometryExtrude, materialExtrude);
        ...
        let geometryBox = new THREE.BoxGeometry(.09, .20, .05);
        let materialBox = new THREE.MeshToonMaterial({ color: 0x7FFF24 });
        let alienBody = new THREE.Mesh(geometryBox, materialBox);
        alienBody.position.set(0, -.35, 0);
        alienGuy.add(alienBody);

        geometry = new THREE.BoxGeometry(.035, .15, .05);
        let alienRightArm = new THREE.Mesh(geometry, material);
        alienRightArm.position.set(-.1, -.4, 0);
        alienGuy.add(alienRightArm);

        let alienLeftArm = alienRightArm.clone();
        alienLeftArm.position.set(.1, -.4, 0);
        alienGuy.add(alienLeftArm);

        let alienRightLeg = alienRightArm.clone();
        alienRightLeg.position.set(-.04, -.5, 0);
        alienGuy.add(alienRightLeg);

        let alienLeftLeg = alienRightLeg.clone();
    ...
    let addSucculent = document.getElementById('succulentBtn');
    addSucculent.addEventListener('click', createSucculent, false);

    function createSucculent() {

        let geometry = new THREE.BoxGeometry(.25, .15, .05);
        let material = new THREE.MeshBasicMaterial({ color: 0xffff00, transparent: true, opacity: 0 });
        let newSucculent = new THREE.Mesh(geometry, material);
    ...
    let addCactus = document.getElementById('cactusBtn');
    ...
    function createCactus() {
        ...
        let geometry = new THREE.BoxGeometry(.25, .55, .05);
        let material = new THREE.MeshBasicMaterial({ color: 0xffff00, transparent: true, opacity: 0 });
        let newCactus = new THREE.Mesh(geometry, material);


        let geometrySphere = new THREE.SphereGeometry(.085, 5, 3.5);
        let materialSphere = new THREE.MeshToonMaterial({
            color: 0x004932,
            roughness: 0.8,
            shading: THREE.FlatShading,
        });
        let cactusTop = new THREE.Mesh(geometrySphere, materialSphere);
        cactusTop.rotation.set(0, -3.5, 0);
        cactusTop.position.set(0, .28, 0);

        let geometryCylinder = new THREE.CylinderGeometry(.075, .075, .60, 5);
        let cactusArm = new THREE.Mesh(geometry, material);
    ...
    function manipulateObjs() {
        ...
        let rotateObj = document.getElementById('rotateBtn');
        rotateObj.addEventListener('click', function () {

            activeObj.rotateY(.5);
        }, false);

        let removeObj = document.getElementById('removeBtn');
        ...
        let clearScene = document.getElementById('clearBtn');
        ...
        let moveBackward = document.getElementById('moveBackward');
...
function renderContainer() {
    ...
    let addAnimation = document.getElementById('animateBtn');
