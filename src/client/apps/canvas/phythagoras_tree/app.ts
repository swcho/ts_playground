...
const calcBranches = (function () {
    ...
    let memoize = function (width: number, scale: number, lean: number) {
...
// DRAW TREE
// ================================================================================
function drawTree(size: number, scale: number, lean: number, level: number) {
...
function update() {
    ...
    drawTree(boxSize, scale, lean, maxLevel);
